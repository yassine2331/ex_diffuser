...
def CF_generation(model,vae,classifier, scheduler, source_loader, config, target_attrs, interventions , NUMBER_OFITERARIONS=1, weight=0.0):
    ...
    folder_name = folder_name+ "_final_EXAMPLES_" +str(weight) + "/" + folder_name + "_"+ str(target_attrs[folder_name])+"_" + str(int(list(interventions.values())[0]))
...
def main():
    ...
    CF_generation(model,vae,classifier, scheduler, source_loader, config, target_attrs, interventions , 10,weight=3)
