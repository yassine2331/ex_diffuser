...
def CF_generation(model,vae,classifier, scheduler, source_loader, config, target_attrs, interventions , NUMBER_OFITERARIONS=1, weight=0.0):
    ...
    folder_name = folder_name+ "_final_EXAMPLES_PARAMETER" + "/" + folder_name + "_"+ str(target_attrs[folder_name])+"_" + str(int(list(interventions.values())[0]))
    ...
    for i in tqdm(range(NUMBER_OFITERARIONS)):
        ...
        generated_1 , x_t = denoise_with_interventions_new(
        model=model,
        vae=vae,
        scheduler=scheduler,
        z=z,
        ...
        generated_2 , x_t = denoise_with_interventions_new(
        model=model,
        vae=vae,
        scheduler=scheduler,
        z=z,
        ...
        generated_3 , x_t = denoise_with_interventions_new(
        model=model,
        vae=vae,
        scheduler=scheduler,
        z=z,
        ...
        generated_4 , x_t = denoise_with_interventions_new(
        model=model,
        vae=vae,
        scheduler=scheduler,
        z=z,
        ...
        generated_5 , x_t = denoise_with_interventions_new(
        model=model,
        vae=vae,
        scheduler=scheduler,
        z=z,
        ...
        start_index_cbm_1 = save_images(generated_1, folder_name + "/images_cbm_1", start_index_cbm_1)
        start_index_cbm_2 = save_images(generated_2, folder_name + "/images_cbm_2", start_index_cbm_2)
        start_index_cbm_3 = save_images(generated_3, folder_name + "/images_cbm_3", start_index_cbm_3)
        start_index_cbm_4 = save_images(generated_4, folder_name + "/images_cbm_4", start_index_cbm_4)
        start_index_cbm_5 = save_images(generated_5, folder_name + "/images_cbm_5", start_index_cbm_5)
