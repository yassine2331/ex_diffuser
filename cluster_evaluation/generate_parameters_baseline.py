...
def denoise_with_interventions_new(model, vae, scheduler, z, attributes, 
    ...
    del logits, grad_cls, x_in, x_est, x_t, noisy_z, noise, t
...
def CF_generation(model,vae,classifier, scheduler, source_loader, config, target_attrs, interventions , NUMBER_OFITERARIONS=1, weight=0.0):
    ...
    folder_name = folder_name+ "_PARAMETER_BASELINE" + "/" + folder_name + "_"+ str(target_attrs[folder_name])+"_" + str(int(list(interventions.values())[0]))
    ...
    for i in tqdm(range(NUMBER_OFITERARIONS)):
        ...
        generated_baseline_1 , z_baseline = denoise_with_interventions_dvce(
        model=model,
        vae=vae,
        classifier=classifier,
        scheduler=scheduler,
        z=z,
        noise_start=201,         # ⬅️ amount of noise added
        intervention_strength=0.03,  # ⬅️ controls intensity of interventions
        interventions=interventions,
        distance_strength=0.15
        )
        
        generated_baseline_2 , z_baseline = denoise_with_interventions_dvce(
        model=model,
        vae=vae,
        classifier=classifier,
        scheduler=scheduler,
        z=z,
        noise_start=201,         # ⬅️ amount of noise added
        intervention_strength=0.04,  # ⬅️ controls intensity of interventions
        interventions=interventions,
        distance_strength=0.15
        )
        ...
        generated_baseline_3 , z_baseline = denoise_with_interventions_dvce(
        model=model,
        vae=vae,
        classifier=classifier,
        scheduler=scheduler,
        ...
        generated_baseline_4 , z_baseline = denoise_with_interventions_dvce(
        model=model,
        vae=vae,
        classifier=classifier,
        scheduler=scheduler,
        z=z,
        noise_start=201,         # ⬅️ amount of noise added
        intervention_strength=0.07,  # ⬅️ controls intensity of interventions
        interventions=interventions,
        distance_strength=0.15
        )
        ...
        generated_baseline_5 , z_baseline = denoise_with_interventions_dvce(
        model=model,
        vae=vae,
        classifier=classifier,
        scheduler=scheduler,
        ...
        start_index_cbm_1 = save_images(generated_baseline_1, folder_name + "/images_baseline_1", start_index_cbm_1)
        start_index_cbm_2 = save_images(generated_baseline_2, folder_name + "/images_baseline_2", start_index_cbm_2)
        start_index_cbm_3 = save_images(generated_baseline_3, folder_name + "/images_baseline_3", start_index_cbm_3)
        start_index_cbm_4 = save_images(generated_baseline_4, folder_name + "/images_baseline_4", start_index_cbm_4)
        start_index_cbm_5 = save_images(generated_baseline_5, folder_name + "/images_baseline_5", start_index_cbm_5)
...
def main():
    ...
    CF_generation(model,vae,classifier, scheduler, source_loader, config, target_attrs, interventions , 10)
